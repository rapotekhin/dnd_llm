...
- [0006-exploration-side-session-summary.md](0006-exploration-side-session-summary.md) — возврат из side-сессии (social/trade/combat) в exploration через явную синхронную суммаризацию
